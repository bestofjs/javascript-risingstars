...
At #3, Next.js 16 introduced the [cached components](https://nextjs.org/blog/next-16#cache-components) to make caching more explicit and flexible. Developers can create static page shells that include dynamic content streaming from the server.
